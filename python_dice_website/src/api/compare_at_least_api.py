...
class CompareAtLeastApi(i_api_type.IApi):
    ...
    _HElP_TEXT = (
        ...
        "   eg compareatleast?program_one=2d6%20%2B%202&program_two=2d10%20-%202&program_one_name=hammer&program_two_name=bow\n"
        '       %20 = " "\n'
        '       %2B = "+"\n'
        "   note names are optional"
    )
    _ROUTE = "/compareatleast"
    ...
    def add_to_app(flask_app: flask.Flask) -> None:
        ...
        def compare_at_least_api():
            if flask.request.method == "POST":
                return compare_at_least_api_post()
            return compare_at_least_api_get()
    ...
    @staticmethod
    def get_name() -> str:
        return CompareAtLeastApi._HELP_NAME

    @staticmethod
    def get_help_text() -> str:
        return CompareAtLeastApi._HElP_TEXT

    @staticmethod
    def get_route() -> str:
        return CompareAtLeastApi._ROUTE
