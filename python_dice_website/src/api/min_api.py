...
class MinApi(i_api_type.IApi):
    ...
    def add_to_app(self, flask_api: api.Api, name_space: api.Namespace) -> None:
        local_logger = global_logger.ROOT_LOGGER.getChild(MinApi.__name__)
        ...
        class Min(resource.Resource):
            ...
            def post():
                ...
                try:
                    return interpreter.min(split_program)["stdout"]
