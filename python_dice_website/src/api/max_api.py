...
class MaxApi(i_api_type.IApi):
    ...
    def add_to_app(self, flask_api: api.Api, name_space: api.Namespace) -> None:
        local_logger = global_logger.ROOT_LOGGER.getChild(MaxApi.__name__)
        ...
        class Max(resource.Resource):
            ...
            def post():
                ...
                try:
                    return interpreter.max(split_program)["stdout"]
